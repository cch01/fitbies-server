...
import { ToggleParticipantMediaInput } from '../dto/meeting.input';
...
export const toggleParticipantMedia = (ctx: MeetingServiceCtx) => async (
  { meetingId, participantId, videoOff, muted }: ToggleParticipantMediaInput,
  currentUser: User,
): Promise<Meeting> => {
